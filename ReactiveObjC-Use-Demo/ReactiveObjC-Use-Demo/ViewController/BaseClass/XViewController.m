...
// viewModel
@property (nonatomic, readwrite, strong) XViewModel *viewModel;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    XViewController *viewController = [super allocWithZone:zone];
...
- (instancetype)initWithViewModel:(XViewModel *)viewModel {
    self = [super init];
    if (self) {
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    /// 隐藏导航栏细线
    self.viewModel.prefersNavigationBarBottomLineHidden?[(XNavigationController *)self.navigationController hideNavigationBottomLine]:[(XNavigationController *)self.navigationController showNavigationBottomLine];
