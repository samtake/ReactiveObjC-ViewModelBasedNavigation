...
- (void)_setupNavigationBarBottomLine{
    ...
    UIImageView *navSystemLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.navigationBar.mh_height - navSystemLineH, X_SCREEN_WIDTH, navSystemLineH)];
    navSystemLine.backgroundColor = XRandomColor;
