...
+ (UIViewController *)currentViewController {
    ...
    if ([resultVC isKindOfClass:[XHomeController class]]) {
        XHomeController *mainVc = (XHomeController *)resultVC;
...
{
    XViewController *topViewController = (XViewController *)[self topNavigationController].topViewController;
    
    /// 确保解析出来的类 也是 MHViewController
    NSAssert([topViewController isKindOfClass:XViewController.class], @"topViewController is not an MHViewController's subclass: %@", topViewController);
